...
int main(int argc, char **argv) {
    ...
    // Address 0x28000 is the fixed location of overlay_timer_irq_handler in firmware
    volatile void (**overlay_timer_irq_handler_ptr)(void) = (void (**)(void))0x28000;
    *overlay_timer_irq_handler_ptr = timer_ms_irq_handler;

    printf("Timer handler registered at 0x28000\r\n");
